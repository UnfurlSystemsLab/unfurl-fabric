 ...
 * whether it is bound by the host environment rather than another catalog component.
 *
 ...
 * @param hostBound          true if the host environment supplies this dependency (not a catalog component).
 */
